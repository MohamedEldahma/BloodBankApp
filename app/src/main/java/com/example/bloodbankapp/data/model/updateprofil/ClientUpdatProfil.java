...
public class ClientUpdatProfil {
    ...
    @SerializedName("city")
    @Expose
    private CityUpdatProfil city;
    @SerializedName("blood_type")
    @Expose
    private BloodTypeUpdatProfil bloodType;
    ...
    public CityUpdatProfil getCity() {
        return city;
    }

    public void setCity(CityUpdatProfil city) {
        this.city = city;
    }

    public BloodTypeUpdatProfil getBloodType() {
        return bloodType;
    }

    public void setBloodType(BloodTypeUpdatProfil bloodType) {
