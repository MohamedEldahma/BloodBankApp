...
public class ClientRegiter {
    ...
    @SerializedName("city")
    @Expose
    private CityRegiter city;
    @SerializedName("blood_type")
    @Expose
    private BloodTypeRegiter bloodType;
    ...
    public CityRegiter getCity() {
        return city;
    }

    public void setCity(CityRegiter city) {
        this.city = city;
    }

    public BloodTypeRegiter getBloodType() {
        return bloodType;
    }

    public void setBloodType(BloodTypeRegiter bloodType) {
