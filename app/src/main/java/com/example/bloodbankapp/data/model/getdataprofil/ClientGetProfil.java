...
public class ClientGetProfil {
    ...
    @SerializedName("city")
    @Expose
    private CityGetProfil city;
    @SerializedName("blood_type")
    @Expose
    private BloodTypeGetProfil bloodType;
    ...
    public CityGetProfil getCity() {
        return city;
    }

    public void setCity(CityGetProfil city) {
        this.city = city;
    }

    public BloodTypeGetProfil getBloodType() {
        return bloodType;
    }

    public void setBloodType(BloodTypeGetProfil bloodType) {
