...
public class CityRegiter {
    ...
    @Expose
    private GovernorateRegiter governorate;
    ...
    public GovernorateRegiter getGovernorate() {
        return governorate;
    }

    public void setGovernorate(GovernorateRegiter governorate) {
