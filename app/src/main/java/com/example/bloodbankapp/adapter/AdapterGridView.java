...
public class AdapterGridView extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.set_adapter_gride_views, parent, false);

            viewHolder = new ViewHolder();

            viewHolder.setAdapterGridChk = convertView.findViewById(R.id.setAdapter_GridChk);
